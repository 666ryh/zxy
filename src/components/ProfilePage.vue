...
<template>
 <view class="profile-page">
  ...
  <view class="profile-body">
   ...
   <button role="button" tabindex="0" class="huihui-card" @click="state.supportOpen=true"><view class="huihui-avatar">辉</view><view><text class="huihui-title">有问题，就来找辉辉</text><text class="huihui-sub">自动回复 · 趣味聊天</text></view><AppIcon name="arrow" :size="17"/></button>
